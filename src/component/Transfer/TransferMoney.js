...
const TransferMoney = () => {
  ...
  useEffect(() => {
    axios.get(`https://bankingankit.herokuapp.com/api/customers`).then(res => {
  ...
  useEffect(() => {
    axios
      .get(`https://bankingankit.herokuapp.com/api/customer/${location.state.id}`)
      .then(res => {
        const persons = res.data;
        setcustomer(persons);
  ...
  const onchangeAmount = e => {
    ...
    axios
      .get(`https://bankingankit.herokuapp.com/api/customer/${UserSelectedID}`)
      .then(res => {
        const persons = res.data;
  ...
  const onProceed = () => {
    ...
    try {
      axios({
        method: 'put',
        url: 'https://bankingankit.herokuapp.com/api/customer',
        data: params,
        headers: {
    ...
    axios({
      method: 'post',
      url: 'https://bankingankit.herokuapp.com/api/history',
      data: values,
      headers: {
        'Content-Type': 'application/json',
      },
